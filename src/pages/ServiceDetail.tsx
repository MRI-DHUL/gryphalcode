...
const serviceData: Record<string, Service> = {
  'software-development': {
    ...
    image: '/images/service-software-development.svg',
  ...
  'mobile-applications': {
    ...
    image: '/images/service-mobile-applications.svg',
  ...
  'cloud-backend': {
    ...
    image: '/images/service-cloud-backend.svg',
  ...
  'software-modernization': {
    ...
    image: '/images/service-software-modernization.svg',
  ...
  'technical-consulting': {
    ...
    image: '/images/service-technical-consulting.svg',
...
export default function ServiceDetail() {
  ...
  return <div className="inner-page">
    ...
    <section className="page-hero service-detail-hero">
      <div>
        <p className="eyebrow">GRYPHALCODE SERVICES</p>
        <h1>{service.title}<br /><span>built for the real world.</span></h1>
        <p>{service.description}</p>
        <NavLink className="primary-button" to="/contact">Discuss your project <ArrowUpRight size={17} /></NavLink>
      </div>
      <div className="service-detail-visual">
        <img src={service.image} alt="" width="800" height="500" />
      </div>
    </section>
    <section className="section detail-grid">
      <div className="section-label">WHAT WE CAN HELP WITH</div>
      <div>
        <h2>Focused engineering,<br /><span>clear outcomes.</span></h2>
        <div className="detail-points">{service.points.map((point) => <div key={point}><Check size={17} />{point}</div>)}</div>
      </div>
    </section>
